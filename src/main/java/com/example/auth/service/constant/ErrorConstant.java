...
public class ErrorConstant {
    ...
    public static final String ERROR_PASSWORD_REQUIRED = "Password cannot be blank.";
    ...
    public static final String USERNAME_ALREADY_EXISTS_ERROR_DESC
            = "This username is already in use. Please choose another one.";

    public static final String EMAIL_ALREADY_EXISTS_ERROR_CODE = "EMAIL_ALREADY_EXISTS";
    public static final String EMAIL_ALREADY_EXISTS_ERROR_DESC
